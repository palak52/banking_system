...
.nav-link1{color:black;}
    ...
    <table class="table roundedCorners  tabletext table-hover table-condensed table-dark" >
        ...
        <?php
            ...
            // $result = mysqli_query($conn, "SELECT * FROM trans") or die("Error: " . mysqli_error($conn));
            // {
        ?>
            <tr>
            <td><?php echo $sql['id']; ?></td>
            <td><?php echo $sql['fromuser']; ?></td>
            <td><?php echo $sql['touser']; ?></td>
            <td><?php echo $sql['transamount']; ?> </td>
            </tr>
