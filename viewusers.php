...
<head>
    ...
    <title>Pal's Basic banking System</title>
        ...
        <br>
            ...
            <div class="row">
                ...
                <?php
                      ...
                      $sql = mysqli_query($conn,"select * from `user_reg`");
                      $i = 1;
                      // while($rows=mysqli_fetch_array($sql)){
                        // $sql = mysqli_query($con, "SELECT * FROM user") or die("Error: " . mysqli_error($con));
                ?>
                    <tr>
                        ...
                        <td><a href="users.php?id= <?php echo $sql['id'] ;?>"> <button type="button" class="button">Transfer</button></a></td>
                    </tr>
                <!-- <?php
                    // }
                ?> -->
